...
describe "my app", ->
    ...
    describe "view1", ->
        ...
        it "should render view1 when user navigates to /view1", ->
            expect(element.all(by_.css("[ng-view] p")).first().getText()).toMatch /partial for view 1/
    ...
    describe "view2", ->
        ...
        it "should render view2 when user navigates to /view2", ->
            expect(element.all(by_.css("[ng-view] p")).first().getText()).toMatch /partial for view 2/